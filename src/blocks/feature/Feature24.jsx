...
export default function Feature24({ heading, caption, image, list }) {
...
Feature24.propTypes = { heading: PropTypes.string, caption: PropTypes.string, image: PropTypes.any, list: PropTypes.array };
